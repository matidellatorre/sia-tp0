...
def plot_ej2b(filename):
    ...
    plt.scatter(hps, catch_rate_pokeball, color='blue', label='Pokeball')
    plt.plot(hps, catch_rate_pokeball, color='blue')
    plt.scatter(hps, catch_rate_fastball, color='green', label='Fastball')
    plt.plot(hps, catch_rate_fastball, color='green')
    plt.scatter(hps, catch_rate_ultraball, color='red', label='Ultraball')
    plt.plot(hps, catch_rate_ultraball, color='red')
    plt.scatter(hps, catch_rate_heavyball, color='orange',label='Heavyball')
    plt.plot(hps, catch_rate_heavyball, color='orange')
...
def plot_ej2c(filename):
    ...
    plt.scatter(lvls, catch_rate_pokeball, color='blue', label='Pokeball')
    plt.plot(lvls, catch_rate_pokeball, color='blue')
    plt.scatter(lvls, catch_rate_fastball, color='green', label='Fastball')
    plt.plot(lvls, catch_rate_fastball, color='green')
    plt.scatter(lvls, catch_rate_ultraball, color='red', label='Ultraball')
    plt.plot(lvls, catch_rate_ultraball, color='red')
    plt.scatter(lvls, catch_rate_heavyball, color='orange', label='Heavyball')
    plt.plot(lvls, catch_rate_heavyball, color='orange')
